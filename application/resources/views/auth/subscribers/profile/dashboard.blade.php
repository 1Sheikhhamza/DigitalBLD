            ...
            <main class="col-lg-9 pe-4">
                ...
                <div class="row g-4">
                    ...
                    <section class="col-md-6">
                        <div style="width: 100%; min-height:280px; height:auto;"
                            class=" p-3 rounded h-100 d-flex flex-column bg-white">
                            <div class="section-header d-flex justify-content-between align-items-center">
                                <h5>Bookmark</h5>
                                <a href="{{ route('subscriber.bookmark') }}" class="see-more">See all <i
                                        class="bi bi-chevron-right ms-1"></i></a>
                            </div>

                            <div class="flex-grow-1 overflow-auto">
                                @forelse($bookmarkedDecisions as $bookmark)
                                    <a class="content-card d-flex align-items-center"
                                        href="{{ route('subscriber.singleDecision', [$bookmark->id, Crypt::encrypt('dashboard')]) }}">
                    ...
                    <section class="col-md-6">
                        <div style="width: 100%; min-height: 280px;" class="p-3 rounded h-100 d-flex flex-column bg-white">
                            <div class="section-header d-flex justify-content-between align-items-center">
                                <h5>My Folder</h5>
                                <a href="{{ route('subscriber.myFolder') }}" class="see-more">See all <i
                                        class="bi bi-chevron-right ms-1"></i></a>
                            </div>
                            <div class="row overflow-auto">
                                @forelse($folders as $folder)
                                    <div class="col-sm-3 p-0">
                                        <a href="{{ route('subscriber.files.index', Crypt::encrypt($folder->id)) }}"
                                            class="content-card folder-item">
