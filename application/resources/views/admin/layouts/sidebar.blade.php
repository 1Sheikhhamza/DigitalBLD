    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                @if(hasAnyPermissionOnResource('volumes'))
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            @can('volumes.view')
                                <li class="nav-item">
                                    <a href="{{ route('volumes.index', ['type' => 'BLD']) }}" class="nav-link">
                                        <i class="nav-icon bi bi-list"></i>
                                        <p>BLD Volume List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('volumes.index', ['type' => 'SCOB']) }}" class="nav-link">
                                        <i class="nav-icon bi bi-list"></i>
                                        <p>SCOB Volume List</p>
                                    </a>
                                </li>
                            @endcan
                            @can('volumes.create')
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            @can('ocr_extractions.view')
                                <li class="nav-item">
                                    <a href="{{ route('ocr_extractions.index', ['division_type' => 'BLD']) }}" class="nav-link">
                                        <i class="nav-icon bi bi-list"></i>
                                        <p>BLD Decisions</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('ocr_extractions.index', ['division_type' => 'SCOB']) }}"
                                        class="nav-link">
                                        <i class="nav-icon bi bi-list"></i>
                                        <p>SCOB Decisions</p>
                                    </a>
                ...
                @endif
                {{-- Announcement --}}
                @if(hasAnyPermissionOnResource('announcements'))
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="nav-icon bi bi- megaphone"></i>
                            <p>Announcement <i class="nav-arrow bi bi-chevron-right"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
